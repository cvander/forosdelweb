package com.forosdelweb.reader
{
	...
	public class postItem extends MovieClip
	{
		...
		private function populateInfo()
		{
			...
			more_txt.htmlText = "<a href=\"event:"+itemData.categories+"\">Publicado en el foro <font color='#EEBB66'>" + itemData.categories + "</font> hace " + dateUtils.dateDiff(itemData.pubDate ) + "</a>";
