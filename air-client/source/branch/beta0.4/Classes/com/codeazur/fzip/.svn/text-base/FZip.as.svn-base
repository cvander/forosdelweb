...
package com.codeazur.fzip
{
	 ...
	 * loaded successfully.
	 *
	 * @eventType com.codeazur.fzip.FZipEvent.FILE_LOADED
	 */
	[Event(name="fileLoaded", type="com.codeazur.fzip.FZipEvent")]

	/**
	 * Dispatched when an error is encountered while parsing a 
	 * ZIP Archive.
	 *
	 * @eventType com.codeazur.fzip.FZipErrorEvent.PARSE_ERROR
	 */
	[Event(name="parseError", type="com.codeazur.fzip.FZipErrorEvent")]
